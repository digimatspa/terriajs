...
var createMapboxBaseMapOptions = require("./createMapboxBaseMapOptions");
...
var MapboxCatalogItem = require("../Models/MapboxMapCatalogItem");

var createGlobalBaseMapOptions = function(terria, bingMapsKey) {
  var result = createBingBaseMapOptions(terria, bingMapsKey);

  var mapbox = createMapboxBaseMapOptions(
    terria,
    terria.configParameters.mapboxKey
  );
