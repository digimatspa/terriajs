...
var Cesium3DTileset = require("terriajs-cesium/Source/Scene/Cesium3DTileset")
  .default;
var Cesium3DTileStyle = require("terriajs-cesium/Source/Scene/Cesium3DTileStyle")
  .default;
...
const HeadingPitchRange = require("terriajs-cesium/Source/Core/Matrix4")
  .default;
  ...
  if (!defined(this._tileset)) {
    ...
    if (this.clampToGround) {
      this._tileset.readyPromise.then(function(tileset) {
        ...
        // the offset is calculated from the tileset center, so it's not accurate
        // we really need the minimum height here
        var heightOffset = -cartographic.height + 10; //
