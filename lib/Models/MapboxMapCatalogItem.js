...
MapboxCatalogItem.prototype._createImageryProvider = function() {
  var result = new MapboxImageryProvider({
  ...
  result.defaultSaturation = this.saturation;
  result.defaultHue = this.hue;
  result.defaultBrightness = this.brightness;
  result.defaultAlpha = this.alpha;
