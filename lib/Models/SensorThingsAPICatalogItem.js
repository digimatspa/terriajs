...
var SensorThingsAPICatalogItem = function(terria, url) {
   ...
   * {@link SensorThingsAPICatalogItem.defaultRequestTemplate} is used.
 ...
 * @private
 */
function createMappingFromLocationMembers(locationMembers) {
  var mapping = {};
  locationMembers.forEach(member => {
      ...
      member.Things.forEach(function(thing) {
        thing.Datastreams.forEach(function(datastream) {
          ...
          mapping[identifier] = {
            ...
            type: '<a href="#">' + datastream["@iot.selfLink"] + "</a>"
          };
        });
      });
