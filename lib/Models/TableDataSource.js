...
var Math = require("terriajs-cesium/Source/Core/Math").default;
...
function addPointToEntity(
  ...
  if (
    ...
    if(tableColumnStyle.rotationColumn != null && entity.properties.hasOwnProperty(tableColumnStyle.rotationColumn)){
      entity.billboard.rotation = Math.toRadians(entity.properties[tableColumnStyle.rotationColumn].getValue());
