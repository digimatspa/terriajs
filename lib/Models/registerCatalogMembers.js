...
var SensorThingsAPICatalogItem = require("./SensorThingsAPICatalogItem");
...
var ArchesBIMCatalogGroup = require("./ArchesBIMCatalogGroup");
...
var registerCatalogMembers = function() {
  ...
  createCatalogMemberFromType.register("sta", SensorThingsAPICatalogItem);
  createCatalogMemberFromType.register(
    "terria-json",
  ...
  createCatalogMemberFromType.register(
    "pointcloud-arches",
    ArchesPointCloudsCatalogGroup
  );
  createCatalogMemberFromType.register("bim-arches", ArchesBIMCatalogGroup);
