...
var createOsmBuildings = require("terriajs-cesium/Source/Scene/createOsmBuildings")
  .default;
...
Cesium.prototype.createOsmBuildings = function(options) {
  return createOsmBuildings(options);
};
