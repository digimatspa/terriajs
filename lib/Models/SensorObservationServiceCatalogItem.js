    ...
    if (defined(observationData)) {
      ...
      observations.forEach(observation => {
        ...
        if (defined(observation.result.MeasurementTimeseries)) {
          ...
          defined(observation.phenomenonTime) &&
          defined(observation.phenomenonTime.TimeInstant) &&
          defined(observation.phenomenonTime.TimeInstant.timePosition)
        ) {
          //SensorML case
          measurements.push({
      ...
      if (defined(posString.split)) {
        ...
        if (coords.length === 2) {
          ...
          mapping[identifier] = {
            ...
            type: monitoringPoint.type && monitoringPoint.type["xlink:href"]
          };
